...
<!-------------------------------------------------------------------------------------------------------------->
<div id= "sidenav" style="background-color: #8B0000">
	<u>
		<div id="menu"><li>
		...
		<div id="menu"><li>
			<button id="dash-page" onclick="loadDoc('dash.php','',0)" class="bts"><div  id="hm" > </div>Home</button>
...
<div style=" height: 1000PX; width: 100%; overflow: hidden;">
  ...
  <div id="content" >
		...
		<div id="class-i">
			<div id="c-img"></div>
			 <a href="instructor/exams.php">Create Exam</a> 
		...
		<div id="class-i">
			<div id="c-img"></div>
			<a href="instructor/examresults.php">Exam Results</a>
		...
		<div id="class-i">
			<div id="c-img"></div>
			<a href="instructor/questions.php">Question Bank</a>
